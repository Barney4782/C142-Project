...
def popular_articles():
    ...
    for index, row in output.iterrows():
        ...
        popular_articles_data.append(dictionary)
...
def recommended_articles():
    ...
    names = ["url", "title", "text", "lang", "total_events"]
    all_recommended = pd.DataFrame(columns=names)

    for like_art in liked_articles:
        output = get_recommendations(like_art["title"])
    ...
    for index, row in all_recommended.iterrows():
        ...
        recommended_article_data.append(dictionary2)
